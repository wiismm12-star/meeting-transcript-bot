...
class LocalWebCorrectionTests(unittest.TestCase):
    ...
    def test_edit_page_exposes_local_audio_and_segment_alignment(self) -> None:
        ...
        self.assertIn(b'class="avatar play-segment" data-start="1.5"', page.data)
        self.assertIn(b'class="time play-segment" data-start="1.5"', page.data)
        self.assertIn(b'class="chip-dot speaker-jump"', page.data)
